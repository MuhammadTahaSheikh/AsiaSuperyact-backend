...
// Additional Product Routes for Frontend
Route::get('/yacht-for-sale-products', [ProductController::class, 'getYachtForSaleProducts']);
Route::get('/charter-yachts-products', [ProductController::class, 'getCharterYachtsProducts']);

// Routes for Properties
Route::get('/property', [PropertyController::class, 'getAllProperties']);
Route::get('/property/{id}', [PropertyController::class, 'getPropertyByID']);
